...
(call_script, "script_get_max_skill_of_player_party", "skl_trade"),
  ...
  (
    ...
    "Disguised in the garments of a poor pilgrim, you fool the guards and make your way into the {s20}.",
    "none",
    [
      (party_get_slot, ":ptype", "$current_town", slot_party_type),
      (try_begin),
        (eq, ":ptype", spt_castle),
        (str_store_string, s20, "str_castle"),
      (else_try),
        (str_store_string, s20, "str_town"),
      (try_end),
    ],
    [
      ("continue",[],"Continue...",
 ...
 You must flee back through the gates before all the guards in the {s20} come down on you!",
    "none",
    [
