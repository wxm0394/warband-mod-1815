...
##        (overlay_set_text, "$g_multiplayer_team_2_score_display_overlay", "str_s0_dd_reg0"),
  ...
  ("banner_selection",0,mesh_load_window,[
      ...
      (ti_on_presentation_event_state_change,
       [(store_trigger_param_1, ":object"),
        # P6: If the player displaced another lord's banner earlier, restore that lord's banner to the player's CURRENT banner instead of leaving it checkered.
        (try_begin),
          ...
          (try_end),
          (assign, "$g_troop_take_back_banner", 0),
        (try_end),
        (try_begin),
        ...
        (else_try),
          ...
          # P6: Remember who we displaced, so the next banner change can restore them.
